...
with col1:
    st.markdown("""
    [📊 Performance Results](https://github.com/keithcockerham/Wind_Farm/results/)
    
    Complete results for all farms.
    """)

with col2:
    st.markdown("""
    [🔍 Download Code](https://github.com/keithcockerham/Wind_Farm/notebooks/)
